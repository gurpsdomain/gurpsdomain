...
public class SheetSheet {
    ...
    private final List<SheetNote> notes = new ArrayList<SheetNote>();
    private final SheetAttributes attributes;

    public SheetSheet(Map<String, String> metaData, SheetPoints sheetPoints, List<SheetAdvantage> sheetAdvantages, List<SheetSkill> sheetSkills, List<SheetNote> sheetNotes, SheetAttributes sheetAttributes) {
