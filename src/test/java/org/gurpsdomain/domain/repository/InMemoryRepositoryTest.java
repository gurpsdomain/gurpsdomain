...
public class InMemoryRepositoryTest {
    ...
    private static final AdvantageDescription ANY_ADVANTAGE = new AdvantageDescription("testName", 10, 1, 5, "B128", Arrays.asList(new ModifierDescription("ModifierDescription 1", new CostDescription(10, "points"), "B129")),Arrays.asList(new AttributeBonusDescription("HT", "1")),Arrays.asList(new SkillBonusDescription("Stealth", "2")));
